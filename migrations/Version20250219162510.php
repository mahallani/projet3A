 ...
 */
final class Version20250219162510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_grossesse ADD patient_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_grossesse DROP patient_id');
    }
}
