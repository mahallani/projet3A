...
{
    #[Route('/indexfront/{id}', name: 'app_suivi_grossesse_index', methods: ['GET'])]
    public function index(SuiviGrossesseRepository $suiviGrossesseRepo, int $id): Response
    {
        // Récupérer les suivis de grossesse pour l'ID spécifié
        $suiviGrossesses = $suiviGrossesseRepo->findBy(['id' => $id]);
